...
if __name__ == '__main__':
    ...
    for i in range(0, 10):
        ...
        # remain_gallery_path_list_per_query_img, key: query_img_path. value: remain_gallery_img_path
        TP_list, FP_list, TN_list, FN_list, F1_list, remain_filtered_gallery_features_dict, remain_gallery_path_list_per_query_img = generate_filtered_gallery(i, gallery_real_attribute, gallery_fake_features_attr)

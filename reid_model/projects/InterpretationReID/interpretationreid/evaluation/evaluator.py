...
def inference_only_gallery(model, data_loader, evaluator,name_of_attribute=None):
    """
    Run model on the data_loader and save the gallery features and attribute with pkl.
    ...
    Returns:
        The return value of gallery outputs, attribute_dict
...
def inference_only_one_img(model, data_loader, evaluator,name_of_attribute=None):
    """
    Run model on the data_loader and return the image features and attribute dict.

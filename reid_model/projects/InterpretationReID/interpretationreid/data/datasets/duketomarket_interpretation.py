...
__all__ = ['DukeToMarket_Interpretation']
...
class DukeToMarket_Interpretation(ImageDataset):
    """Market1501.
    ...
    def __init__(self, root='datasets', market1501_500k=False, **kwargs):
        ...
        self.key_attribute = ['backpack', 'bag', 'boots', 'downblack', 'downblue', 'downbrown', 'downgray', 'downgreen', 'downred', 'downwhite', 'gender', 'handbag', 'hat', 'shoes', 'top', 'upblack', 'upblue', 'upbrown', 'upgray', 'upgreen', 'uppurple', 'upred', 'upwhite']
        ...
        super(DukeToMarket_Interpretation, self).__init__(train, query, gallery, **kwargs)
    ...
    def process_dir(self, dir_path, is_train=True):
        ...
        for img_path in img_paths:
            ...
            #print(str(pid))
            if pid == 0:
                p_attribute = -1*torch.ones(size=(23,))
            else:
                p_attribute = torch.ones(size=(23,))
            if is_train:

...
__all__ = ['Market1501_And_Interpretation']


# transfer pedestrian attribute to representation in market_attribute_and.mat
...
# the list of empty pedestrian attributes in market_attribute_and.mat
AttrEmpty = ['wearing boots', 'long coat']

# the list of ambiguous pedestrian attributes in market_attribute_and.mat
...
class Market1501_And_Interpretation(ImageDataset):
    """Market1501.
    ...
    def __init__(self, root='datasets', market1501_500k=False, **kwargs):
        ...
        print("==============================================")
        print("market1501_and_interpretation!!!!!!")
        print("==============================================")
        ...
        self.market_attribute_path = osp.join(self.data_dir, 'market_attribute_and.mat')
        ...
        super(Market1501_And_Interpretation, self).__init__(train, query, gallery, **kwargs)
    ...
    def process_dir(self, dir_path, is_train=True):
        ...
        for img_path in img_paths:
            ...
            #print(str(pid))
            if pid == 0:
                p_attribute = -1*torch.ones(size=(18,))
            else:

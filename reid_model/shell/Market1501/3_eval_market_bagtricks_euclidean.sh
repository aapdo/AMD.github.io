...
python3 ./projects/InterpretationReID/train_net.py --config-file ./projects/InterpretationReID/configs/Market1501_Circle/circle_R50_ip.yml --eval-only MODEL.WEIGHTS ./logs/market1501/bagtricks_circle_R50/model_final.pth MODEL.DEVICE "cuda:0"
